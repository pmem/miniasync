...
/*
 * fut_has_property -- returns 1 if a property is set and 0 otherwise.
 * It's an abstract implementation, which works for both regular and
 * chained futures.
 */
static inline int fut_has_property(struct future *fut,
		enum FUTURE_PROPERTY property)
{
...
static inline int future_has_property_default(void *future,
		enum FUTURE_PROPERTY property)
{
...
static inline int future_chain_has_property(void *future,
		enum FUTURE_PROPERTY property)
{
